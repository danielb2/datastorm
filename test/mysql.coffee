...
class Actor extends DataStorm.Model
  @db = DB
...
describe "Mysql", ->
  beforeEach (done) ->
    ...
    exec 'mysql -uroot datastorm_test < test/datastorm_test.sql', ->
      done()
  describe "Model", ->
    ...
    it "should save a new item", (done) ->
      item = new Item id: 190, name: "the new item"
      item.save (err, result) ->
