...
internals.Model.prototype.build_one_to_many_function = function(association) {
    ...
    return function() {
        ...
        key_link = association.key || Lingo.en.singularize(this.constructor.model_name()).toLowerCase() + "_id";
...
internals.Model.table_name = function() {
    ...
    return Lingo.underscore(Lingo.en.pluralize(this.model_name()));
};

internals.Model.model_name = function() {

    return Lingo.capitalize(Lingo.en.singularize(this._name || this.name));
};
